  ...
  const compare = async (nftUrl) => {
    const res = await fetch("https://api.anthropic.com/v1/messages", {
      ...
      body: JSON.stringify({
        ...
        max_tokens: 120,
        system:
          'Visual similarity scorer. Return ONLY valid JSON: {"score":<0-100>,"reason":"<8 words>"}. 0=different,100=identical. Judge art style, traits, colors, mood.',
        messages: [
          {
            role: "user",
            content: [
    ...
    return JSON.parse(
      (d.content?.[0]?.text || '{"score":0,"reason":"error"}')
        .replace(/```json|```/g, "")
        .trim()
    );
  };
  ...
  const run = async () => {
    ...
    try {
      const res = await fetch(
        `https://api.opensea.io/api/v2/collection/${SLUG}/nfts?limit=20`,
    ...
    >
      <div style={{ maxWidth: 680, margin: "0 auto" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          ...
          >
            UPLOAD IMAGE · AI COMPARES · FIND MATCHES
          </div>
        </div>
        ...
        <div
          ...
          style={{
            border: `2px dashed ${img ? "#1a5a2a" : "#161616"}`,
            borderRadius: 12,
            padding: img ? 16 : 52,
            textAlign: "center",
          ...
          {img ? (
            <>
              ...
              <div style={{ textAlign: "left", flex: 1 }}>
                ...
                <div
                  style={{ color: "#2a2a2a", fontSize: 10, marginTop: 6 }}
                >
                  Claude will compare this to each Normie
                </div>
              </div>
              <button
                onClick={(e) => {
            ...
            <div style={{ width: "100%" }}>
              <div style={{ fontSize: 44, opacity: 0.1, marginBottom: 14 }}>
                ⊕
              </div>
              <div
                style={{ color: "#3a3a3a", fontSize: 11, letterSpacing: 3 }}
              >
                DROP IMAGE OR CLICK TO UPLOAD
              </div>
              <div
                style={{ color: "#1e1e1e", fontSize: 10, marginTop: 8 }}
              >
                Any image to find similar Normies
              </div>
            </div>
          )}
        </div>
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          >
            <label style={{ fontSize: 9, letterSpacing: 3, color: "#333" }}>
              OPENSEA API KEY
            </label>
            <a
              ...
              style={{ fontSize: 9, color: "#1a3a5a", textDecoration: "none" }}
            >
              GET FREE KEY ↗
            </a>
          </div>
          <input
            type="password"
            placeholder="Paste your OpenSea API key..."
            value={osKey}
        ...
        >
          ...
          >
            <div>
              ...
              <div style={{ fontSize: 10, color: "#1e1e1e" }}>
                Show only NFTs scoring above this
              </div>
            </div>
            <div
              style={{
                ...
                fontWeight: 900,
                color:
                  thresh >= 80 ? "#5d5" : thresh >= 60 ? "#db5" : "#5af",
              }}
            >
              {thresh}
          ...
          <input
            ...
            style={{
              width: "100%",
              accentColor:
                thresh >= 80 ? "#3c3" : thresh >= 60 ? "#bb3" : "#3af",
              cursor: "pointer",
            }}
          />
          <div
        ...
        <button
          ...
          style={{
            width: "100%",
            padding: "17px 0",
            background: scanning ? "#090909" : "#06182a",
        ...
        >
          {scanning
            ? phase === "fetching"
              ? "⟳  LOADING NORMIES..."
              : `⟳  ANALYZING  ${prog.n} / ${prog.total}  NFTs`
        ...
        {scanning && phase === "analyzing" && (
          ...
          >
            <div
              style={{
                background: "linear-gradient(90deg,#0a3a6a,#5af)",
                height: "100%",
                width: `${prog.total ? (prog.n / prog.total) * 100 : 0}%`,
          ...
          <div>
            ...
            >
              <div style={{ fontSize: 9, letterSpacing: 3, color: "#2a2a2a" }}>
                SHOWING {vis.length} / {results.length} · ≥{thresh}%
              </div>
              <div
                style={{
                  fontSize: 9,
                  letterSpacing: 2,
                  color: phase === "done" ? "#1a4a1a" : "#1a2a3a",
                }}
              >
                    ...
                    >
                      <div style={{ position: "relative" }}>
                        <img
                          ...
                          onError={(e) => {
                            e.target.style.minHeight = "148px";
            ...
            {vis.length === 0 && (
              ...
              >
                ...
                <div style={{ fontSize: 11, letterSpacing: 2 }}>
                  NO RESULTS ABOVE {thresh}%
                </div>
                <div style={{ fontSize: 10, marginTop: 8, color: "#161616" }}>
